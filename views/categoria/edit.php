  ...
  <div class="container-fluid">
    ...
    <form action="<?php echo constant('URL'); ?>categoria/actualizarCate" method="POST" id="form-categoria">
      ...
      <div class="form-group">
        ...
        <textarea name="descripcionCate" id="descripcionCate" class="form-control col-md-4" placeholder="Ingresa una descripción acerca de la Categoria" rows="3" autocomplete="off"><?php echo $this->categorias->descripcionCate; ?></textarea>
      </div>
      <div>
