...
class PersonaModel extends Model{
    ...
    public function insert($datos){
        ...
        if (empty($foto) || empty($comprobante)) {
            echo "vacia";
        }
    ...
    public function update($item){   
        ...
        $query = $this->db->connect()->prepare("UPDATE persona SET nombrePers = :nombrePers, apellido = :apellido, fecha_nac = :fecha_nac, direccion = :direccion, telefono = :telefono, usuario = :usuario, contrasena = :contrasena, foto = :foto, comprobante = :comprobante,  id_rol = :id_rol WHERE id_persona = :id_persona");
        try{
            $query->execute([
