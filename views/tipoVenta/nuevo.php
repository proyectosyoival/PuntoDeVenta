...
<body>
	...
	<div class="container-fluid">
		...
		<h1 id="h1-form">Nuevo Tipo de Venta</h1>
		<hr>
		<form action="<?php echo constant('URL'); ?>tipoVenta/registrarTipo_Venta" method="POST" id="form-tipoVenta">
      <div class="form-group">
        <label for="descripcionTipoVenta">Descripción del Tipo de Venta:</label>
        <textarea name="descripcionTipoVenta" id="descripcionTipoVenta" class="form-control col-md-4" placeholder="Ingresa una descripción acerca del Tipo de Venta" rows="3" autocomplete="off"></textarea>
      </div>
			<div>
